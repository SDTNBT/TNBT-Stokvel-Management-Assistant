...
const NewAdminDashboard = () => {
  ...
  const renderContent = () => {
    ...
    if (activeTab === 'view-members') return <ViewMembers group={group} members={members} onSelectMember={setSelectedMember} />;
            ...
            <li>
              ...
              {isGroupsOpen && (
                <ul className="submenu">
                  <li><button onClick={() => setActiveTab('view-members')} className={`submenu-btn ${activeTab === 'view-members' ? 'active-sub' : ''}`}><Users size={16} /><p>View Member</p></button></li>
